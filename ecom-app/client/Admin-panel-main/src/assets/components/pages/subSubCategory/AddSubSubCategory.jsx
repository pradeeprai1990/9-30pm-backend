  ...
  return (
    <div className="w-full min-h-[680px] px-5 bg-slate-50 py-10">
      <div className="mx-auto">
        ...
        <form onSubmit={handleSubsubCategory} className="border border-slate-200 border-t-0 gap-6 flex bg-white p-6 rounded-b-lg shadow-sm">
