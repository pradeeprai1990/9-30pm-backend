              ...
              return (
                <div className="grid grid-cols-[100px_70px_repeat(4,minmax(120px,1fr))_100px_100px] bg-white border-b text-gray-700">
                  <div className="px-2 py-4">
                    <input
                      type="checkbox"
                      className="sub-sub-category-row-check w-4 h-4 cursor-pointer"
                    />
                  </div>
                  <div className="px-2 py-4"> {index+1} </div>
                  <div className="px-2 py-4">{obj.name}</div>
                  <div className="px-2 py-4">{obj?.parent?.name}</div>
                  <div className="px-2 py-4">{obj?.subCategory?.name}</div>
                 <div className="px-2 py-4">
                  <img src={path+obj.image} width={50} alt="" />
                 </div>
