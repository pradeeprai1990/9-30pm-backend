        ...
        <form className='border border-slate-200 border-t-0 gap-6 flex bg-white p-6 rounded-b-lg shadow-sm'>
          <div className='flex flex-col'>
            ...
            <div className='relative w-60 h-60 border border-slate-200 rounded-lg overflow-hidden shadow bg-slate-100'>
              ...
              <input accept='image/*' className='absolute z-10 inset-0 opacity-0 cursor-pointer' type='file' />
            </div>
          </div>
          <div className='basis-full'>
            <div className='mb-6'>
              <label className='block mb-2 text-md font-medium text-gray-700'>Category Name</label>
              <input type='text' name='name' autoComplete='off' className='text-[17px] border border-slate-300 text-gray-900 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-500 block w-full py-2.5 px-3' placeholder='Enter category name' />
            </div>
            <div className='mb-6'>
