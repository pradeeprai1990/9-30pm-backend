        ...
        <form className='border border-slate-200 border-t-0 gap-6 flex bg-white p-6 rounded-b-lg shadow-sm'>
          ...
          <div className='w-full'>
            ...
            <div className='mb-6'>
              ...
              <input type='text' name='name' autoComplete='off' className='text-[17px] border border-slate-300 text-gray-900 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-500 block w-full py-2.5 px-3' placeholder='Enter sub category name' />
            </div>
            <div className='mb-6'>
